# https://github.com/TracyCuiq/S-UNIWARD-python
...
def S_UNIWARD(coverPath, payload):
    ...
    cover = imageio.imread(coverPath)
    wetCost = 100000000
    k, l, _ = cover.shape
...
coverPath = r'D:\Work\academic\bowsTestcover'
stegoPath = r'D:\Work\academic\bowsTeststego'
